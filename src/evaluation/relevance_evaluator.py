...
class RelevanceEvaluator:
    ...
    def _get_arabic_stopwords(self) -> List[str]:
        ...
        # Add common Islamic inheritance terms that shouldn't be stopwords in this context
        inheritance_terms = [
    ...
    def _extract_keywords(self, text: str) -> List[str]:
        ...
        # Simple Arabic tokenization and cleaning
...
def print_relevance_report(evaluation_result: Dict[str, Any]) -> None:
    ...
    if semantic:
        print("
Semantic Similarity:"        print(".4f"        print(".4f"        print(".4f"
    keyword = evaluation_result['keyword_overlap']
    if keyword:
        print("
Keyword Overlap:"        print(".4f"        print(".4f"
    tfidf = evaluation_result['tfidf_similarity']
    if tfidf:
        print("
TF-IDF Similarity:"        print(".4f"        print(".4f"
    # Retrieval metrics
    retrieval = evaluation_result['retrieval_metrics']
    if retrieval:
        print("
Retrieval Metrics:"        print(".4f"        print(".4f"        print(".4f"        print(f"  True Positives: {retrieval['true_positives']}")
    ...
    if evaluation_result['document_scores']:
        print("
Top Retrieved Document:"        top_doc = evaluation_result['document_scores'][0]
        print(f"  Title: {top_doc['title']}")
        print(".4f"        print(".4f"        print(".4f"        print(f"  Combined Score: {top_doc['combined_score']:.4f}")
